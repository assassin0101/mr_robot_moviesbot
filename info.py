...
BOT_TOKEN = environ.get('BOT_TOKEN', "5998925637:AAGzqXF016VddzBeSZOY7krR8Lynwz20Y5Q")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001633313355 -1001732398496 -1001802127723').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://thepyworld:thepyworld@cluster0.waorhk0.mongodb.net/?retryWrites=true&w=majority")
